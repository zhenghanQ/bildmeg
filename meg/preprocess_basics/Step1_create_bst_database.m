...
SubjectName = {'bildc3307'}; %,};
nSubj = length(SubjectName);
SubjectRaw = {'/Users/zqi/Documents/MIT/MEG/brainstorm_raw/bildc3307_tsss_mc.fif'
    };
...
for subj = 1:nSubj
    ...
    %RawFiles = {...
    %    'G:\tmp\walle_002_tsss_mc.fif'};
    RawFiles = SubjectRaw(subj);
    ...
    sFiles_trials = bst_process('CallProcess', 'process_import_data_event', ...
        sFiles, [], ...
        'subjectname', SubjectNames{1}, ...
    ...
    sFiles_trials = bst_process('CallProcess', 'process_noisecov', ...
        sFiles_trials, [], ...
        'baseline', [-0.1, -0.001], ...
        'target', 1, ...
        'dcoffset', 1, ...
