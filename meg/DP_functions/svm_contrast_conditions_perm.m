...
% Example:
%   %parameters
%   param.brainstorm_db = 'D:\brainstorm_db\myproject\data\';
%   param.data_type = 'MEG';
%   param.f_lowpass = 30; %set 0 for no filtering
%   param.num_permutations = 200;
...
for p = 1:num_permutations
    ...
    for tndx = 1:ntimes
        ...
        model = libsvmtrain(train_label',train_trials(:,:,tndx),'-s 0 -t 0 -q');
        [predicted_label, accuracy, decision_values] = libsvmpredict(test_label', test_trials(:,:,tndx), model);
